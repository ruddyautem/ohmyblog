    ...
    <div className="space-y-12 sm:space-y-16">
      ...
      <section className="relative overflow-hidden rounded-3xl border border-zinc-200/80 bg-zinc-50/50 p-8 sm:p-12 lg:p-14 shadow-xs">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-10">
          ...
          <div className="hidden lg:block w-96 xl:w-[410px] shrink-0 self-center">
            <Link
              href="/write"
              className="group relative block rounded-3xl border border-zinc-200/90 bg-white p-7 xl:p-8 shadow-xs transition-all duration-200 hover:border-zinc-900 hover:shadow-md"
            >
              {/* Brand Header */}
              <div className="flex items-center gap-3.5 border-b border-zinc-100 pb-5">
                ...
                <div>
                  <span className="text-base font-bold text-zinc-900 block">OhMyBlog!</span>
                  <span className="text-xs sm:text-sm text-zinc-500">Espace contributeur</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between rounded-xl bg-zinc-900 px-5 py-3.5 text-xs sm:text-sm font-semibold text-white shadow-xs transition-colors group-hover:bg-zinc-800">
        ...
        <div className="flex flex-col-reverse lg:flex-row lg:items-start gap-10 lg:gap-12">
          ...
          <div className="w-full lg:w-8/12">
            <div className="mb-8 flex items-center justify-between border-b border-zinc-100 pb-4">
              <div>
                <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-zinc-900">Posts récents</h2>
          ...
          <aside className="w-full lg:w-4/12 space-y-6">
            ...
            <div className="rounded-3xl border border-zinc-200/80 bg-white p-7 shadow-xs">
              <h3 className="mb-4 text-xs font-bold uppercase tracking-wider text-zinc-400 pl-2">À la une</h3>
